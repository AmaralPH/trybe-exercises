...
const orderModifier = (order) => {
  ...
  let bebida = Object.keys(order.order.drinks);
  return `Olá ${order.name}, o total do seu pedido de ${pedidos[0]}, ${pedidos[1]} e ${order.order.drinks.coke.type} é R$ ${order.payment.total},00."`
}
