...
let valorCusto = 10, valorVenda = 15, impostoSobreOCusto = valorCusto * 0.2;
let valorCustoTotal = valorCusto + impostoSobreOCusto;
let lucro = valorVenda - valorCustoTotal;
let lucro1000 = lucro * 1000;

if (valorCusto < 0 || valorVenda < 0) {
    console.log("Valores informado inválidos");
} else {
    console.log("R$ " + lucro1000 + ",00");
};
